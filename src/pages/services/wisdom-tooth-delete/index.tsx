            ...
            <div className="content">
              ...
              <div className="information-container">
                ...
                <div className="plate">
                  ...
                  <section className="tab-three">
                    <span className="text">
                      Закрытый кюретаж в области 1 зуба <br /> <br /> (ХР-А22)
                    </span>
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      ...
                      Ивантеевке мы предлагаем {""}
                      <a href="https://dental-home.ru/services/teeth-delete">
                        удаление зуба
                      </a>{" "}
                      мудрости, верхнего и нижнего зуба мудрости, а также
                      удаление 2 или 4 зубов мудрости.
                    </p>
                  </div>
