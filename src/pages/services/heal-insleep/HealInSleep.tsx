              ...
              <div className="heading-container">
                <div className="bread-dots">
                  ...
                  <Link to="/services/healing-in-sleep" className="link active">
                    Лечеиие зубов во сне
                  </Link>
                </div>
                <h1 className="heading">
                  Лечение зубов под наркозом в Ивантеевке
                </h1>
              ...
              <div className="information-container">
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    Лечение зубов под наркозом в Ивантеевке – это идеальный
                    выбор для тех, кто боится похода к стоматологу. Наша клиника
                    предлагает лечение зубов во сне наркозом как для взрослых,
                    так и для детей.
                    <br /> <br />
                    Мы понимаем, что многие люди испытывают тревогу и страх
                    перед лечением зубов. Поэтому мы предоставляем услугу
                    лечения зубов под наркозом, чтобы вы могли чувствовать себя
                    комфортно и спокойно в процессе процедуры.
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    Цена на лечение зубов под наркозом зависит от сложности
                    процедуры и индивидуальных особенностей пациента. Но мы
                    гарантируем, что наши цены будут доступными и адекватными.
                    <br />
                    <br />
                    Лечение зубов под сном – это возможность получить здоровые и
                    красивые зубы без боли и стресса. Не откладывайте поход к
                    стоматологу на потом! Запишитесь на лечение зубов под
                    наркозом в Ивантеевке уже сегодня и получите
              ...
              <div className="services-content">
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      Лечение зубов под наркозом в Ивантеевке – это идеальный
                      выбор для тех, кто боится похода к стоматологу. Наша
                      клиника предлагает лечение зубов во сне наркозом как для
                      взрослых, так и для детей. <br /> <br />
                      Мы понимаем, что многие люди испытывают тревогу и страх
                      перед лечением зубов. Поэтому мы предоставляем услугу
                      лечения зубов под наркозом, чтобы вы могли чувствовать
                      себя комфортно и спокойно в процессе процедуры.
                      <br />
                      <br />
                      Кроме того, мы предлагаем{" "}
                      ...
                      {""}
                      {""} Лечение зубов у детей может быть очень сложным и
                      требует особого подхода. Наша команда опытных стоматологов
                      готова предложить ребенку лечение зубов под наркозом,
                      чтобы он мог пройти процедуру без стресса и боли.
                      <br />
                      <br />
                      Лечение зубов под наркозом – это не только безболезненный
                      ...
                      <br />
                      <br />
                      Лечение зубов под сном – это возможность получить здоровые
                      и красивые зубы без боли и стресса. Не откладывайте поход
                      к стоматологу на потом! Запишитесь на лечение зубов под
                      наркозом в Ивантеевке уже сегодня и получите
                      профессиональную помощь в достижении желаемого результата.
                      Наша стоматологическая клиника готова помочь вам в любое
                      время!
