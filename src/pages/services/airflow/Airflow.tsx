  ...
  return (
    <div className="div">
      <Helmet>
        <meta charSet="utf-8" />
        <title>
          Чистка зубов AirFlow в Ивантеевке | Стоматологии Dental Home{" "}
        </title>
        <meta
          property="og:title"
          content="Чистка зубов AirFlow в Ивантеевке | Стоматологии Dental Home"
        ></meta>
        <meta
      ...
      {isLoading ? (
        ...
        <div className="screen">
          <Helmet>
            ...
            <meta
              property="og:description"
              content="Отбелите зубы и получите свежее дыхание с чисткой зубов AirFlow в Ивантеевке. Запишитесь на прием в нашу сеть стоматологий уже сегодня!"
            ></meta>
            <meta
              name="description"
              content="Отбелите зубы и получите свежее дыхание с чисткой зубов AirFlow в Ивантеевке. Запишитесь на прием в нашу сеть стоматологий уже сегодня!
          ...
          <main className="services-screen-mobile">
            <div className="content">
              ...
              <div className="heading-container">
                ...
                <h1 className="heading">Чистка зубов AirFlow в Ивантеевке </h1>
              ...
              <div className="information-container">
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    Профессиональная чистка зубов - это не только косметическая
                    процедура, но и необходимая мера для поддержания здоровья
                    полости рта. Если вы ищете профессиональную гигиену зубов в
                    Ивантеевке, то мы готовы предложить вам комплексную
                    процедуру, включающую удаление зубного налета и безопасное
                    удаление зубного камня с помощью ультразвуковой аппаратуры.
                    Наша стоматология предлагает чистку зубов air flow -
                    инновационную технологию, которая позволяет эффективно и
                    безболезненно удалить зубной налет и отбелить эмаль. Airflow
                    чистка - это не только процедура для удаления зубного
                    налета, но и отличный способ предотвратить развитие кариеса,
                    пародонтоза и других патологий. Наш стоматолог-гигиенист
                    проведет профессиональную чистку зубов, используя только
                    современное оборудование и материалы, чтобы обеспечить
                    максимальную эффективность и безопасность процедуры.
                    <br />
                    <br />
                    Чистка air flow зубы - это не только профилактика
                    заболеваний полости рта, но и возможность получить красивую
                    улыбку. Отбеливание Air Flow позволяет удалить зубные пятна
                    и придать эмали более белый оттенок, что делает улыбку более
                    привлекательной и уверенной. Чистка аир флоу в Ивантеевке
                    доступна для всех наших пациентов по доступной цене. Мы
                    ценим каждого клиента и готовы предложить индивидуальный
                    подход к каждому случаю. Наша цель - помочь вам сохранить
                    здоровье зубов и десен, а также красивую улыбку на долгие
                    годы.
                    <br />
                    <br />
                    Не откладывайте визит к стоматологу на потом. Запишитесь на
                    профессиональную чистку зубов air flow в Ивантеевке уже
                    сегодня и получите эффективную профилактику заболеваний
                    полости рта по доступной цене. Наш стоматолог-гигиенист
                    сделает все возможное, чтобы ваша улыбка всегда была
                    здоровой и красивой.
                  </p>
                </section>
                <div className="divider"></div>
                <div className="plate">
                  ...
                  <section className="tab-three">
                    <span className="text">
                      ...
                      средств и предметов гигиены полости рта <br />{" "}
                      (А14.07.008)
                    </span>
                  ...
                  <section className="tab-three">
                    <span className="text">
                      ...
                      профосмотре(1 раз в 6 месяцев) <br /> (А16.07.051.002)
                    </span>
                  ...
                  <section className="tab-three">
                    <span className="text">
                      ...
                      AirFlow (1 челюсть) <br /> (А16.07.051.004)
                    </span>
                  ...
                  <section className="tab-three">
                    <span className="text">
                      ...
                      "Fluocal gel" (2 челюсти) 1й сеанс <br /> (А16.07.051.005)
                    </span>
                    <span className="price">От 2.500₽</span>
                  </section>
                  <section className="tab-three">
                    <span className="text">
                      Снятие зубных отложений пастой, полировка, покрытие
                      "Fluocal gel" последующий сеанс <br /> (А16.07.051.006)
                    </span>
                  ...
                  <section className="tab-three">
                    <span className="text">
                      ...
                      отложений в области 1 зуба <br /> (А22.07.002)
                    </span>
              ...
              <div className="upper-content">
                <div className="heading-container">
                  ...
                  <h1 className="heading" style={{ width: "30%" }}>
                    Чистка зубов AirFlow в Ивантеевке{" "}
                  </h1>
              ...
              <div className="services-content">
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      Профессиональная чистка зубов - это не только
                      косметическая процедура, но и необходимая мера для
                      поддержания здоровья полости рта. Если вы ищете
                      профессиональную гигиену зубов в Ивантеевке, то мы готовы
                      предложить вам комплексную процедуру, включающую удаление
                      зубного налета и безопасное удаление зубного камня с
                      помощью ультразвуковой аппаратуры. Наша стоматология
                      предлагает чистку зубов air flow - инновационную
                      технологию, которая позволяет эффективно и безболезненно
                      удалить зубной налет и отбелить эмаль. Airflow чистка -
                      это не только процедура для удаления зубного налета, но и
                      отличный способ предотвратить развитие кариеса,
                      пародонтоза и других патологий. Наш стоматолог-гигиенист
                      проведет профессиональную чистку зубов, используя только
                      современное оборудование и материалы, чтобы обеспечить
                      максимальную эффективность и безопасность процедуры.
                      ...
                      <br />
                      Чистка air flow зубы - это не только профилактика
                      заболеваний полости рта, но и возможность получить
                      красивую улыбку. Отбеливание Air Flow позволяет удалить
                      зубные пятна и придать эмали более белый оттенок, что
                      делает улыбку более привлекательной и уверенной. Чистка
                      аир флоу в Ивантеевке доступна для всех наших пациентов по
                      доступной цене. Мы ценим каждого клиента и готовы
                      предложить индивидуальный подход к каждому случаю. Наша
                      цель - помочь вам сохранить здоровье зубов и десен, а
                      также красивую улыбку на долгие годы.
                      <br />
                      <br />
                      Не откладывайте визит к стоматологу на потом. Запишитесь
                      на профессиональную чистку зубов air flow в Ивантеевке уже
                      сегодня и получите эффективную профилактику заболеваний
                      полости рта по доступной цене. Наш стоматолог-гигиенист
                      сделает все возможное, чтобы ваша улыбка всегда была
                      здоровой и красивой.
                    ...
                    <div className="prices">
                      ...
                      <div className="price-row">
                        <span className="text">
                          ...
                          полировка (1 зуб) <br /> (А16.07.051.003)
                        </span>
                        <span className="price">От 50₽</span>
                      </div>
                      <div className="price-row">
                      ...
                      <div className="price-row">
                        <span className="text">
                          Снятие зубных отложений пастой, полировка, покрытие
                          "Fluocal gel" (2 челюсти) 1й сеанс <br />{" "}
                          (А16.07.051.005)
                        </span>
                        <span className="price">От 2.500₽</span>
                      </div>
                      <div className="price-row">
                        <span className="text">
                          Снятие зубных отложений пастой, полировка, покрытие
                          "Fluocal gel" последующий сеанс <br />{" "}
                          (А16.07.051.006)
                        </span>
                        <span className="price">От 1.500₽</span>
                      </div>
                      ...
                      <div className="price-row">
                        <span className="text">
                          ...
                          зубных отложений в области 1 зуба <br /> (А22.07.002 )
                        </span>
                        <span className="price">От 150₽</span>
                      </div>
                    </div>
