              ...
              <div className="information-container">
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    ...
                    не рекомендуется {""}
                    {""}
                    <a href="https://dental-home.ru/services/xray">
                      {""} {""}
                      делать общий рентген.
                    </a>
                    {""}
                    {""}
                    Прицельный снимок зуба позволяет получить необходимую
                    информацию о состоянии зубов и не наносит вреда будущему
                    малышу.
                    <br />
                    <br />
