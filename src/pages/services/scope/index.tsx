...
`;
  ...
  return (
    <div className="div">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Прицельный снимок зубов в Ивантеевке | Dental Home </title>
        <meta
          property="og:title"
          content="Прицельный снимок зубов в Ивантеевке | Dental Home  "
        ></meta>
        <meta
          property="og:description"
          content="Высокоточный прицельный снимок зубов в стоматологии Dental Home. Опытные стоматологи и современное оборудование. Записывайтесь на прием уже сегодня! 
"
        ></meta>
        <meta
          name="description"
            ...
            <div className="content">
              ...
              <div className="heading-container">
                <div className="bread-dots">
                  ...
                  <div className="circle"></div>
                  <Link to="/services/scope" className="link active">
                    Прицельный снимок
                  </Link>
                </div>
                <h1 className="heading">
                  Прицельный снимок зубов в Ивантеевке
                </h1>
              ...
              <div className="information-container">
                ...
                <section className="information">
                  <h3 className="information-heading">
                    Прицельный снимок зуба: точная диагностика в стоматологии
                  </h3>
                  <p className="information-paragraph">
                    Как часто вы задумывались о том, что скрыто за поверхностью
                    вашего зуба? К сожалению, многие заболевания зубов и десен
                    не проявляются сразу и могут привести к серьезным
                    последствиям. Чтобы избежать этого, в стоматологии
                    используют прицельный снимок зуба.
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                  <h3 className="information-heading">Что это за процедура?</h3>
                  <p className="information-paragraph">
                    Прицельный рентгеновский снимок - это диагностический метод,
                    который позволяет получить точную картину зуба и его корней.
                    С помощью этого снимка стоматолог может выявить кариес,
                    опухоли, воспаления и другие заболевания, которые не видны
                    на обычном рентгене.
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    Эта процедура особенно важна для беременных женщин, которым
                    не рекомендуется делать общий рентген. Прицельный снимок
                    зуба позволяет получить необходимую информацию о состоянии
                    зубов и не наносит вреда будущему малышу.
                    <br />
                    <br />
                    Рентген прицельный снимок - это быстрый и удобный метод
                    диагностики, который позволяет стоматологу получить
                    максимально точную информацию о состоянии зубов и десен.
                    Если вы хотите сделать прицельный снимок зуба в Ивантеевке,
                    то мы готовы предложить вам качественную услугу по доступной
                    цене.
                    <br />
                    <br />
                    Сделать прицельный снимок зуба - это не только
                    профилактическая мера, но и возможность сохранить здоровье
                    своих зубов на долгие годы. Не откладывайте заботу о своем
                    здоровье на потом. Запишитесь на прицельный снимок зуба в
                    Ивантеевке уже сегодня и получите точную диагностику для
                    своего здоровья.
                  </p>
                </section>
                <div className="divider"></div>
              ...
              <div className="services-content">
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      Как часто вы задумывались о том, что скрыто за
                      поверхностью вашего зуба? К сожалению, многие заболевания
                      зубов и десен не проявляются сразу и могут привести к
                      серьезным последствиям. Чтобы избежать этого, в
                      стоматологии используют прицельный снимок зуба.
                    </p>
                  </div>
                  <div className="information-two mt-5">
                    ...
                    <p className="p-info">
                      ...
                      метод, который позволяет получить точную картину зуба и
                      его корней. С помощью этого снимка стоматолог может
                      выявить кариес, опухоли, воспаления и другие заболевания,
                  ...
                  <div className="information-two mt-5">
                    ...
                    <p className="p-info">
                      Эта процедура особенно важна для беременных женщин,
                      которым не рекомендуется делать общий рентген. Прицельный
                      снимок зуба позволяет получить необходимую информацию о
                      состоянии зубов и не наносит вреда будущему малышу.
                      <br />
                      <br />
                      Рентген прицельный снимок - это быстрый и удобный метод
                      диагностики, который позволяет стоматологу получить
                      максимально точную информацию о состоянии зубов и десен.
                      Если вы хотите сделать прицельный снимок зуба в
                      Ивантеевке, то мы готовы предложить вам качественную
                      услугу по доступной цене.
                      <br />
                      <br />
                      Сделать прицельный снимок зуба - это не только
                      профилактическая мера, но и возможность сохранить здоровье
