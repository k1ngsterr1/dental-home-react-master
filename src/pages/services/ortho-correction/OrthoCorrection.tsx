            ...
            <div className="content">
              ...
              <div className="heading-container">
                <div className="bread-dots">
                  ...
                  <div className="circle"></div>
                  <Link to="/services/ortho-correction" className="link active">
              ...
              <div className="information-container">
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    ...
                    способ исправить неправильное положение зубов и получить
                    прекрасную улыбку. Наша клиника предлагает качественные
                    услуги по установке брекетов, которые помогут вам достичь
                    ...
                    откладывайте поход к стоматологу на потом!
                    <br />
                    <br />
                    Запишитесь на консультацию по установке брекетов уже сегодня
                    и получите профессиональную помощь в достижении желаемого
                    результата.
                  </p>
                </section>
                <div className="divider"></div>
                ...
                <div className="plate">
                  <section className="tab-one">
                    ...
                    <span className="text">
                      I степений сложности <br /> <br /> (ОРД-А16.07.048.001){" "}
                    </span>
                    <span className="price">От 65.000₽</span>
                  </section>
                  <section className="tab-two">
                    <span className="text">
                      II степений сложности <br /> <br /> (ОРД-А16.07.048.002){" "}
                    </span>
                    <span className="price">От 70.000₽</span>
                  </section>
                  <section className="tab-three">
                    <span className="text">
                      III степений сложности <br /> <br /> (ОРД-А16.07.048.003){" "}
                    </span>
                    <span className="price">От 75.000₽</span>
                  </section>
                  <section className="tab-three">
                    <span className="text">
                      Фиксация брекет-системы (одна челюсть) <br /> <br />{" "}
                      (ОРД-А16.07.048.004 )
                    </span>
                  ...
                  <section className="tab-three">
                    <span className="text">
                      Брекет-система металлическая безлигатурная <br /> <br />{" "}
                      (ОРД-А16.07.048.006)
                    </span>
                  ...
                  <section className="tab-three">
                    <span className="text">
                      Брекет-система Damon Q <br /> <br /> (ОРД-А16.07.048.007){" "}
                    </span>
                    <span className="price">От 30.000₽</span>
                  </section>
                  <section className="tab-three">
                    <span className="text">
                      Брекет-система сапфировая, керамическая <br /> <br />{" "}
                      (ОРД-А16.07.048.008)
                    </span>
                  ...
                  <section className="tab-three">
                    <span className="text">
                      Брекет-система керамическая безлигатурная <br /> <br />{" "}
                      (ОРД-А16.07.048.009)
                    </span>
                  ...
                  <section className="tab-three">
                    <span className="text">
                      Фиксация одного брекета <br /> <br /> (ОРД-А16.07.048.010){" "}
                    </span>
                    <span className="price">От 2.500₽</span>
                  </section>
                  <section className="tab-three">
                    <span className="text">
                      Замена одного брекета <br /> <br /> (ОРД-А16.07.048.011){" "}
                    </span>
                    <span className="price">От 3.000₽</span>
                  </section>
                  <section className="tab-three">
                    <span className="text">
                      Снятие брекетов с одного зубного ряда <br /> <br />{" "}
                      (ОРД-А16.07.048.012 )
                    </span>
                  ...
                  <section className="tab-three">
                    <span className="text">
                      Установка открывающей, закрывающей пружины <br /> <br />{" "}
                      (ОРД-А16.07.048.015)
                    </span>
                  ...
                  <section className="tab-three">
                    <span className="text">
                      Наложение длинной лигатуры <br /> <br />{" "}
                      (ОРД-А16.07.048.018){" "}
                    </span>
                  ...
                  <section className="tab-three">
                    <span className="text">
                      Изгиб на дуге <br /> <br /> (ОРД-А16.07.048.019){" "}
                    </span>
                ...
                >
                  <section className="tab-one">
                    ...
                    <span className="text">
                      Несъемный ретейнер на 1 зубной ряд <br /> <br />{" "}
                      (ОРД-А16.07.018)
                    </span>
                  ...
                  <section className="tab-two">
                    <span className="text">
                      Ретенционный съемный аппарат на 1 зубной ряд <br /> <br />{" "}
                      (ОРД-А16.07.047.009)
                    </span>
                  ...
                  <section className="tab-three">
                    <span className="text">
                      Снятие ретейнера <br /> <br /> (ОРД-А16.07.048.021 ){" "}
                    </span>
                    <span className="price">От 5.000₽</span>
                  </section>
                  <section className="tab-three">
                    <span className="text">
                      Починка несъемного ретейнера <br /> <br />{" "}
                      (ОРД-А23.07.001.002){" "}
                    </span>
                    <span className="price">От 2.000₽</span>
                  </section>
                  <section className="tab-three">
                    <span className="text">
                      Изготовление ретенционной каппы <br /> <br /> (ОРД-А24)
                    </span>
                ...
                >
                  <section className="tab-one">
                    ...
                    <span className="text">
                      Леченте с помощью аппарат Марко-Росса <br /> <br />{" "}
                      (ОРД-A16.07.046.001 )
                    </span>
                  ...
                  <section className="tab-two">
                    <span className="text">
                      Активация ортодонтического винта <br /> <br />{" "}
                      (ОРД-23.07.002.052)
                    </span>
                    <span className="price">От 2.500₽</span>
                  </section>
                  <section className="tab-three">
                    <span className="text">
                      Аппарат для дистализации моляров <br /> <br />{" "}
                      (ОРД-A16.07.046.002)
                    </span>
                  ...
                  <section className="tab-three">
                    <span className="text">
                      Лечение с помощью небного бюгеля <br /> <br />{" "}
                      (ОРД-A16.07.046.003)
                    </span>
                  ...
                  <section className="tab-three">
                    <span className="text">
                      Межчелюстные тяги <br /> <br /> (ОРД-A16.07.046.004){" "}
                    </span>
                    <span className="price">От 500₽</span>
                  </section>
                  <section className="tab-three">
                    <span className="text">
                      Изготовление коронки ортодонтической <br /> <br />{" "}
                      (ОРД-A23.07.002.055)
                    </span>
                    <span className="price">От 5.000₽</span>
                  </section>
                  <section className="tab-three">
                    <span className="text">
                      Изготовление кольца-петли ортодонического <br /> <br />{" "}
                      (ОРД-А23.07.002.051)
                    </span>
                  ...
                  <section className="tab-three">
                    <span className="text">
                      Изготовление прикусного шаблона <br /> <br />{" "}
                      (ОРД-A02.07.010.005)
                    </span>
                    <span className="price">От 500₽</span>
                  </section>
                  <section className="tab-three">
                    <span className="text">
                      ...
                      головы) <br /> <br /> (ОРД-А02.07.004)
                    </span>
                    <span className="price">От 2.000₽</span>
                  </section>
                  <section className="tab-three">
                    <span className="text">
                      Изготовление контрольной модели (из гипса) <br /> <br />{" "}
                      (ОРД-А23.07.002.027)
                    </span>
                    <span className="price">От 500₽</span>
                  </section>
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      ...
                      эффективный способ исправить неправильное положение зубов
                      ...
                      <br />
                      <br />
                      Запишитесь на консультацию по установке брекетов уже
                  ...
                  >
                    ...
                    <div className="prices">
                      ...
                      <div className="price-row">
                        <span className="text">
                          Изготовление ретенционной каппы <br /> <br />{" "}
                          (ОРД-А24)
                        </span>
                        <span className="price last">От 6.500₽</span>
                      </div>
                  ...
                  >
                    ...
                    <div className="prices">
                      <div className="price-row">
                        <span className="text">
                          Лечение с помощью аппарат Марко-Росса <br /> <br />{" "}
                          (ОРД-A16.07.046.001)
                        </span>
                        <span className="price">От 29.000₽</span>
                      </div>
                      ...
                      <div className="price-row">
                        <span className="text">
                          ...
                          ТРГ головы) <br /> <br /> (ОРД-А02.07.004)
                        </span>
                        <span className="price">От 2.000₽</span>
                      </div>
                      <div className="price-row">
...
export default OrthoCorrection;
