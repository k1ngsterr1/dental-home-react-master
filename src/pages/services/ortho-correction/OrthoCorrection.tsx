              ...
              <div className="information-container">
                ...
                <div className="plate">
                  <section className="tab-one">
                    ...
                    <span className="text">
                      I степени сложности <br /> <br /> (ОРД-А16.07.048.001){" "}
                    </span>
                  ...
                  <section className="tab-three">
                    <span className="text">
                      III степени сложности <br /> <br /> (ОРД-А16.07.048.003){" "}
                    </span>
                ...
                >
                  ...
                  <section className="tab-three">
                    ...
                    <span className="price">От 9.400₽</span>
                  </section>
                  <section className="tab-three">
                    <span className="text">
                  ...
                  <section className="tab-three">
                    ...
                    <span className="price">От 4800₽</span>
                  </section>
                  <section className="tab-three">
                    <span className="text">
