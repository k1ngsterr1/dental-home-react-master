...
`;
  ...
  return (
    <div className="div">
      <Helmet>
        <meta charSet="utf-8" />
        <title>МРТ зубов в Ивантеевке | Dental Home </title>
        <meta
          property="og:title"
          content="МРТ зубов в Ивантеевке | Dental Home  "
        ></meta>
        <meta
          property="og:description"
          content="Качественная МРТ диагностика зубов и челюстей в стоматологии Dental Home. Высокоточные результаты и безопасность процедуры. Записывайтесь на МРТ у нас!  
"
        ></meta>
        <meta
          name="description"
            ...
            <div className="content">
              ...
              <div className="heading-container">
                <div className="bread-dots">
                  ...
                  <div className="circle"></div>
                  <Link to="/services/mrt" className="link active">
                    МРТ
                  </Link>
                </div>
                <h1 className="heading">МРТ зубов в Ивантеевке</h1>
              ...
              <div className="information-container">
                ...
                <section className="information">
                  <h3 className="information-heading">
                    МРТ зубов в Ивантеевке: точная диагностика вашего здоровья
                  </h3>
                  <p className="information-paragraph">
                    Если вы столкнулись с проблемами зубов, то вы знаете, как
                    важно получить точную диагностику. К счастью, сегодня
                    существует множество методов диагностики зубов, включая МРТ
                    зубов.
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                  <h3 className="information-heading">Что такое МРТ зубов?</h3>
                  <p className="information-paragraph">
                    МРТ (магнитно-резонансная томография) - это метод
                    диагностики, который использует магнитные поля и радиоволны
                    для создания изображения внутренних органов и тканей. МРТ
                    зубов - это специальный вид МРТ, который позволяет получить
                    изображение зубов и окружающих тканей.
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    Этот метод диагностики позволяет выявить различные
                    заболевания зубов и десен, такие как кариес, опухоли,
                    воспаления и другие. Кроме того, МРТ зубов позволяет
                ...
                <section className="information">
                  <h3 className="information-heading">
                    Сколько стоит МРТ зубов?
                  </h3>
                  <p className="information-paragraph">
                    Цена на МРТ зубов в Ивантеевке зависит от многих факторов,
                    включая количество зубов, которые нужно исследовать, и
                    степень сложности диагностики. Однако, наша клиника
                    предлагает доступные цены на МРТ зубов, чтобы вы могли
                ...
                <section className="information">
                  <h3 className="information-heading">
                    Как сделать МРТ зубов?
                  </h3>
                  <p className="information-paragraph">
                    Процедура довольно проста и безболезненна. Вам нужно будет
                    лечь на кушетку и оставаться неподвижным в течение
                    определенного времени. Во время процедуры вы можете услышать
                    звуковые сигналы, которые связаны с работой МРТ аппарата.
                    <br />
                    <br />
                    Снимок МРТ зубов - это один из самых точных методов {""}
                    <a href="https://dental-home.ru/services/diagnostic">
                      {""} {""}
                      диагностики зубов
                    </a>
                    {""} {""}и десен. Если вы хотите получить точную диагностику
                    и сохранить свое здоровье на долгие годы, то не откладывайте
                    посещение нашей клиники. Мы предлагаем профессиональную
                    услугу по МРТ зубов в Ивантеевке по доступной цене.
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      Если вы столкнулись с проблемами зубов, то вы знаете, как
                      важно получить точную диагностику. К счастью, сегодня
                      существует множество методов диагностики зубов, включая
                      МРТ зубов.
                    </p>
                  </div>
                  <div className="information-two mt-5">
                    ...
                    <p className="p-info">
                      МРТ (магнитно-резонансная томография) - это метод
                      диагностики, который использует магнитные поля и
                      радиоволны для создания изображения внутренних органов и
                      тканей. МРТ зубов - это специальный вид МРТ, который
                  ...
                  <div className="information-two mt-5">
                    ...
                    <p className="p-info">
                      Процедура довольно проста и безболезненна. Вам нужно будет
                      лечь на кушетку и оставаться неподвижным в течение
                      определенного времени. Во время процедуры вы можете
                      услышать звуковые сигналы, которые связаны с работой МРТ
                      аппарата.
                      <br />
                      <br />
                      Снимок МРТ зубов - это один из самых точных методов {""}
                      ...
                      {""} {""} {""} и десен. Если вы хотите получить точную
                      диагностику и сохранить свое здоровье на долгие годы, то
                      не откладывайте посещение нашей клиники. Мы предлагаем
                      профессиональную услугу по МРТ зубов в Ивантеевке по
                      доступной цене. Запишитесь на прием уже сегодня и получите
                      точную диагностику для своего здоровья.
                    </p>
                  </div>
                </div>
              </div>
