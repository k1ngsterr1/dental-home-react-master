                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-two">
                    ...
                    <p className="p-info two">
                      Наши специалисты имеют богатый опыт работы и постоянно
                      совершенствуют свои навыки, чтобы обеспечить нашим
                      пациентам лучшее качество услуг. Мы используем только
                      высококачественные материалы, что гарантирует
                      долговечность и надежность пломбы.
                    </p>
                  </div>
                  <div className="information-two">
                    <h3 className="heading-info two">
                  ...
                  <div className="price-tab" id="prices">
                    ...
                    <div className="prices">
                      ...
                      <div className="price-row last">
                        ...
                        <span className="price last">От 750₽</span>
                      </div>
                    </div>
                  </div>
                  <div
