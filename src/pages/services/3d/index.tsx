              ...
              <div className="information-container">
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    ...
                    . {""}
                    А если добавить к этому 3D-технологию, то получится еще
                    более точная диагностика. 3D снимок полости рта в Ивантеевке
                    - это возможность увидеть все детали структуры зубов и
                    оценить их состояние со всех сторон.
                    <br />
                    <br />
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-two mt-5">
                    ...
                    <p className="p-info">
                      ...
                      . А если добавить к этому 3D-технологию, то получится еще
                      более точная диагностика. 3D снимок полости рта в
                      Ивантеевке - это возможность увидеть все детали структуры
                      зубов и оценить их состояние со всех сторон.
                      <br />
                      <br />
