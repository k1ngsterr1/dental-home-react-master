...
`;
  ...
  return (
    <div className="div">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Удаление зуба мудрости в Ивантеевке | Dental Home</title>
        <meta
          property="og:title"
          content="Удаление зуба мудрости в Ивантеевке | Dental Home "
        ></meta>
        <meta
          property="og:description"
          content="Безболезненное удаление зуба мудрости в стоматологии Dental Home. Опытные стоматологи и современное оборудование. Записывайтесь на прием уже сегодня!
"
        ></meta>
        <meta
          name="description"
            ...
            <div className="content">
              ...
              <div className="heading-container">
                <div className="bread-dots">
                  ...
                  <div className="circle"></div>
                  <Link to="/services/3d" className="link active">
                    3D снимок полости рта
                  </Link>
                </div>
                <h1 className="heading">3D снимок полости рта в Ивантеевке</h1>
              ...
              <div className="information-container">
                ...
                <section className="information">
                  <h3 className="information-heading">
                    3D снимок полости рта в Ивантеевке: качественная диагностика
                    для вашего здоровья
                  </h3>
                  <p className="information-paragraph">
                    Сделать снимок полости рта - легко, быстро и безболезненно.
                    Но как получить максимально точную информацию о состоянии
                    зубов и десен? Ответ прост: выберите панорамный снимок
                    полости рта в Ивантеевке.
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    Этот метод позволяет получить полную картину зубной системы,
                    включая корни зубов и соседние ткани. Благодаря этому,
                    стоматолог может выявить проблемы, которые не видны на
                    обычном рентгене. А если добавить к этому 3D-технологию, то
                    получится еще более точная диагностика. 3D снимок полости
                    рта в Ивантеевке - это возможность увидеть все детали
                    структуры зубов и оценить их состояние со всех сторон.
                    <br />
                    <br />
                    Кроме того, 3D снимок полости рта в Ивантеевке - это быстрый
                    и безопасный метод диагностики. Вы не будете подвергаться
                    излучению, как при обычном рентгене, а процедура займет
                    всего несколько минут.
                    <br />
                    <br />А теперь самое главное - цена. Мы предлагаем
                    панорамный снимок полости рта в Ивантеевке по доступной
                    цене. А если вы выберете 3D-технологию, то получите
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    Запишитесь на панорамный или 3D снимок полости рта в
                    Ивантеевке уже сегодня и получите качественную диагностику
                    для своего здоровья.
                  </p>
                </section>
              </div>
              ...
              <div className="upper-content">
                <div className="heading-container">
                  ...
                  <h1 className="heading" style={{ width: "30%" }}>
                    3D снимок полости рта в Ивантеевке
                  </h1>
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    <h3 className="heading-info">
                      3D снимок полости рта в Ивантеевке: качественная
                      диагностика для вашего здоровья
                    </h3>
                    <p className="p-info">
                      Сделать снимок полости рта - легко, быстро и
                      безболезненно. Но как получить максимально точную
                      информацию о состоянии зубов и десен? Ответ прост:
                  ...
                  <div className="information-two mt-5">
                    ...
                    <p className="p-info">
                      Этот метод позволяет получить полную картину зубной
                      системы, включая корни зубов и соседние ткани. Благодаря
                      этому, стоматолог может выявить проблемы, которые не видны
                      на обычном рентгене. А если добавить к этому
                      3D-технологию, то получится еще более точная диагностика.
                      3D снимок полости рта в Ивантеевке - это возможность
                      увидеть все детали структуры зубов и оценить их состояние
                      со всех сторон.
                      <br />
                      <br />
                      Кроме того, 3D снимок полости рта в Ивантеевке - это
                      быстрый и безопасный метод диагностики. Вы не будете
                      подвергаться излучению, как при обычном рентгене, а
