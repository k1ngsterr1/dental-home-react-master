  ...
  return (
    <div className="div">
      <Helmet>
        <meta charSet="utf-8" />
        <title>
          Металлические брекеты в Ивантеевке в Ивантеевке | Dental Home{" "}
        </title>
        <meta
          property="og:title"
          content="Металлические брекеты в Ивантеевке в Ивантеевке | Dental Home"
        ></meta>
        <meta
          property="og:description"
          content="В Dental Home в Ивантеевке вы можете получить металлические брекеты для эффективной коррекции зубов. Доверьтесь профессионалам!"
        ></meta>
        <meta
          name="description"
          content="В Dental Home в Ивантеевке вы можете получить металлические брекеты для эффективной коррекции зубов. Доверьтесь профессионалам!"
            ...
            <div className="content">
              ...
              <div className="heading-container">
                <div className="bread-dots">
                  ...
                  <div className="circle"></div>
                  <Link to="/services/metal-braces" className="link active">
                    Металлические брекеты
                  </Link>
                </div>
                <h1 className="heading">
                  {" "}
                  Металлические брекеты для зубов в Ивантеевке
                </h1>
              ...
              <div className="information-container">
                ...
                <section className="information">
                  <h3 className="information-heading">
                    Что такое металлические брекеты?
                  </h3>
                  <p className="information-paragraph">
                    Металлические брекеты - это классическое и эффективное
                    решение для исправления неправильного прикуса и кривых
                    зубов. Они состоят из металлических скобок, которые крепятся
                    к зубам, и дуг, которые помогают выравнивать зубы.
                    Металлические брекеты позволяют добиться отличных
                    результатов за сравнительно короткий период времени.
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                  <h3 className="information-heading">
                    Преимущества металлических брекетов в Dental Home
                  </h3>
                  <p className="information-paragraph">
                    В Dental Home мы предлагаем высококачественные металлические
                    брекеты, которые обеспечат вам эффективное и надежное
                    исправление прикуса. Наши специалисты проведут подробную
                    консультацию и разработают индивидуальный план лечения,
                    чтобы достичь оптимальных результатов. Металлические брекеты
                    в Dental Home - это доступное и проверенное временем решение
                    для тех, кто мечтает о прямых зубах.
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                  <h3 className="information-heading">
                    Почему стоит выбрать металлические брекеты в Dental Home?
                  </h3>
                  <p className="information-paragraph">
                    Dental Home - это место, где забота о вашей улыбке
                    становится реальностью. Наши специалисты имеют богатый опыт
                    работы с металлическими брекетами и гарантируют вам комфорт
                    и качество лечения. Мы используем только лучшие материалы и
                    современное оборудование, чтобы обеспечить вам результат, на
                    который вы будете гордиться. Доверьте свою улыбку
                    профессионалам Dental Home и наслаждайтесь прямыми зубами!
                  </p>
                </section>
                <div className="divider"></div>
                <div className="plate">
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      Металлические брекеты - это классическое и эффективное
                      решение для исправления неправильного прикуса и кривых
                      зубов. Они состоят из металлических скобок, которые
                      крепятся к зубам, и дуг, которые помогают выравнивать
                      зубы. Металлические брекеты позволяют добиться отличных
                      результатов за сравнительно короткий период времени.
                    </p>
                  </div>
                  <div className="information-two">
                    ...
                    <p className="p-info">
                      В Dental Home мы предлагаем высококачественные
                      металлические брекеты, которые обеспечат вам эффективное и
                      надежное исправление прикуса. Наши специалисты проведут
                      подробную консультацию и разработают индивидуальный план
                      лечения, чтобы достичь оптимальных результатов.
                      Металлические брекеты в Dental Home - это доступное и
                      проверенное временем решение для тех, кто мечтает о прямых
                      зубах.
                    </p>
                  </div>
                  <div className="information-two">
                    ...
                    <p className="p-info">
                      Dental Home - это место, где забота о вашей улыбке
                      становится реальностью. Наши специалисты имеют богатый
                      опыт работы с металлическими брекетами и гарантируют вам
                      комфорт и качество лечения. Мы используем только лучшие
                      материалы и современное оборудование, чтобы обеспечить вам
                      результат, на который вы будете гордиться. Доверьте свою
                      улыбку профессионалам Dental Home и наслаждайтесь прямыми
                      зубами!
                    </p>
                  </div>
...
export default MetalBracesPage;
