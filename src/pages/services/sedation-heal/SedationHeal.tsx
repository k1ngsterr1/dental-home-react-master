              ...
              <div className="information-container">
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    ...
                    предлагаем детскую стоматологию с использованием седации.
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      ...
                      того, мы предлагаем детскую стоматологию с использованием
                      седации. Лечение зубов у детей может быть очень сложным и
                      требует особого подхода. Наша команда опытных стоматологов
                      готова предложить ребенку лечение зубов под седацией,
