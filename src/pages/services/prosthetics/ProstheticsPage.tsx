    ...
    <div className="div">
      {isLoading ? (
        ...
        <div className="screen">
          <Helmet>
            <meta charSet="utf-8" />
            <title>Протезирование зубов в Ивантеевке в Dental Home</title>
            <meta
              property="og:title"
              content="Протезирование зубов в Ивантеевке в Dental Home"
            ></meta>
            <meta
              property="og:description"
              content="Протезирование на высоком уровне с современными технологиями. Мы предлагаем различные виды протезирования, включая протезирование на имплантах и реконструктивное лечение"
            ></meta>
            <meta
              name="description"
              content="Протезирование на высоком уровне с современными технологиями. Мы предлагаем различные виды протезирования, включая протезирование на имплантах и реконструктивное лечение"
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    ...
                    <a href="https://dental-home.ru/services/implants">
                      используем только качественные имплантаты
                    </a>
                    , которые обеспечивают долговечность и эстетическую
                    привлекательность. Заголовок 2: Преимущества протезирования
                    в клинике Dental Home
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      ...
                      , которые обеспечивают долговечность и эстетическую
                      привлекательность. Заголовок 2: Преимущества
