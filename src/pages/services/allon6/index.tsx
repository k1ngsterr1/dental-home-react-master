    ...
    <div className="div">
      {isLoading ? (
        ...
        <div className="screen">
          <Helmet>
            <meta charSet="utf-8" />
            <title>Имплантация All-on-6 в Ивантеевке | Dental Home</title>
            <meta
              property="og:title"
              content="Имплантация All-on-6 в Ивантеевке | Dental Home"
            ></meta>
            <meta
              property="og:description"
              content="Имплантация All-on-6 в Ивантеевке в клинике Dental Home для полной реставрации зубов. Опытные специалисты помогут восстановить вашу уверенную улыбку"
            ></meta>
            <meta
              name="description"
              content="Имплантация All-on-6 в Ивантеевке в клинике Dental Home для полной реставрации зубов. Опытные специалисты помогут восстановить вашу уверенную улыбку"
            ...
            <div className="content">
              ...
              <div className="heading-container">
                <div className="bread-dots">
                  ...
                  <div className="circle"></div>
                  <Link to="/services/allon6" className="link active">
                    Имплантация All-on-6
                  </Link>
                </div>
                <h1 className="heading">
                  Имплантация зубов All-on-6 в Ивантеевке
                </h1>
              ...
              <div className="information-container">
                ...
                <section className="information">
                  <h3 className="information-heading">
                    Имплантация All-on-6 в Ивантеевке: надежное решение для
                    красивой улыбки
                  </h3>
                  <p className="information-paragraph">
                    Хотите вернуть радость от улыбки и комфорт при приеме пищи?
                    Имплантация All-on-6 - современное и эффективное решение для
                ...
                <section className="information">
                  <h3 className="information-heading">
                    Преимущества имплантации All-on-6 в Dental Home
                  </h3>
                  <p className="information-paragraph">
                    1. Стабильность и надежность: Имплантация All-on-6
                    обеспечивает прочное крепление зубного протеза благодаря
                    использованию шести имплантатов. Это гарантирует
                    стабильность и уверенность при жевании и разговоре.
                    <br /> <br />
                    2. Естественный вид: Благодаря инновационным технологиям и
                    материалам, применяемым в нашей клинике в Ивантеевке, зубной
                    протез на имплантатах All-on-6 выглядит естественно и
                    незаметно для окружающих.
                    <br /> <br />
                    3. Комфорт и удобство: Пациенты отмечают значительное
                    улучшение качества жизни после имплантации All-on-6. Они
                    забывают о проблемах с подвижностью протезов и наслаждаются
                    полноценным образом жизни. Не откладывайте заботу о своем
                    здоровье на потом! Обратитесь к профессионалам в нашей
                    клинике в Ивантеевке и получите консультацию по имплантации
                    All-on-6 уже сегодня. Ваша улыбка заслуживает лучшего!
                  </p>
                </section>
                <div className="divider"></div>
                <div className="plate">
                  ...
                  <section className="tab-three">
                    <span className="text">
                      ...
                      фиксация) <br /> <br /> (ИМ-А16.07.006.015 )
                    </span>
              ...
              <div className="services-content">
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      Хотите вернуть радость от улыбки и комфорт при приеме
                      пищи? Имплантация All-on-6 - современное и эффективное
                      решение для восстановления зубного ряда.
                    </p>
                  </div>
                  <div className="information-two">
                    <h3 className="heading-info two">
                      Преимущества процедуры All-on-6
                    </h3>
                    <p className="p-info two">
                      ...
                      <br /> <br />
                      2. Естественный вид: Благодаря инновационным технологиям и
                      материалам, применяемым в нашей клинике в Ивантеевке,
                      зубной протез на имплантатах All-on-6 выглядит естественно
                      и незаметно для окружающих.
                      <br /> <br />
                      3. Комфорт и удобство: Пациенты отмечают значительное
                      улучшение качества жизни после имплантации All-on-6. Они
                      забывают о проблемах с подвижностью протезов и
                      наслаждаются полноценным образом жизни. <br /> <br />
                      Не откладывайте заботу о своем здоровье на потом!
                      Обратитесь к профессионалам в нашей клинике в Ивантеевке и
                      получите консультацию по имплантации All-on-6 уже сегодня.
