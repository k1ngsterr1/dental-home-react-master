      ...
      {isLoading ? (
        ...
        <div className="screen">
          <Helmet>
            ...
            <meta
              property="og:description"
              content="Восстановите красоту и функциональность своих зубов в Dental Home в Ивантеевке. Надежные методы реставрации подарят вам уверенную улыбку"
            ></meta>
            <meta
              name="description"
              content="Восстановите красоту и функциональность своих зубов в Dental Home в Ивантеевке. Надежные методы реставрации подарят вам уверенную улыбку"
            ...
            <div className="content">
              ...
              <div className="heading-container">
                <div className="bread-dots">
                  ...
                  <div className="circle"></div>
                  <Link to="/services/restoration" className="link active">
                    Реставрация зубов
                  </Link>
                </div>
              ...
              <div className="information-container">
                ...
                <section className="information">
                  <h3 className="information-heading">
                    Реставрация зубов в Ивантеевке: восстановление красоты и
                    здоровья вашей улыбки
                  </h3>
                  <p className="information-paragraph">
                    В нашей стоматологической клинике в Ивантеевке мы предлагаем
                    профессиональную реставрацию зубов, которая поможет вернуть
                    вашей улыбке естественную красоту и здоровье. Наш опытный
                    коллектив специалистов обладает высоким уровнем
                    профессионализма и готов помочь вам достичь идеального
                    результата.
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    Мы понимаем, что каждый случай реставрации уникален, поэтому
                    мы предлагаем индивидуальный подход к каждому пациенту. Наши
                    специалисты проведут тщательное обследование и составят план
                    лечения, учитывая ваши пожелания и потребности. Мы
                    используем только современные материалы и технологии, чтобы
                    обеспечить долговременный и эстетичный результат.
                  </p>
                </section>
                <section className="information">
                  <h3 className="information-heading">
                    Комфортная атмосфера и безболезненные процедуры
                  </h3>
                  <p className="information-paragraph">
                    Посещение стоматолога не должно вызывать стресса или
                    беспокойства. В нашей клинике в Ивантеевке мы создали уютную
                    и спокойную атмосферу, где вы сможете чувствовать себя
                    комфортно. Наши специалисты обладают опытом работы с
                    пациентами разного возраста и помогут вам пройти процедуры
                    реставрации зубов безболезненно и эффективно. <br /> <br />{" "}
                    Приходите к нам в клинику, и мы поможем вам вернуть вашей
                    улыбке естественную красоту и здоровье. Доверьтесь
                ...
                <div className="plate">
                  ...
                  <section className="tab-three">
                    ...
                    <span className="price last">От 950 ₽</span>
                  </section>
                </div>
                <div
                  className="plate"
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      ...
                      предлагаем профессиональную реставрацию зубов, которая
                      поможет вернуть вашей улыбке естественную красоту и
                      здоровье. Наш опытный коллектив специалистов обладает
                      высоким уровнем профессионализма и готов помочь вам
                  ...
                  <div className="information-two">
                    ...
                    <p className="p-info two">
                      Мы понимаем, что каждый случай реставрации уникален,
                      поэтому мы предлагаем индивидуальный подход к каждому
                      пациенту. Наши специалисты проведут тщательное
                      обследование и составят план лечения, учитывая ваши
                      пожелания и потребности. Мы используем только современные
                      материалы и технологии, чтобы обеспечить долговременный и
                  ...
                  <div className="information-two">
                    ...
                    <p className="p-info two">
                      Посещение стоматолога не должно вызывать стресса или
                      беспокойства. В нашей клинике в Ивантеевке мы создали
                      уютную и спокойную атмосферу, где вы сможете чувствовать
                      себя комфортно. Наши специалисты обладают опытом работы с
                      пациентами разного возраста и помогут вам пройти процедуры
                      реставрации зубов безболезненно и эффективно. <br />
                      <br /> Приходите к нам в клинику, и мы поможем вам вернуть
                      вашей улыбке естественную красоту и здоровье. Доверьтесь
                      профессионалам и наслаждайтесь результатом!
                    </p>
                  </div>
                  <div className="divider"></div>
