              ...
              <div className="information-container">
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    ...
                    включая панорамный рентген зубов, рентген корней зубов,
                    рентген молочных зубов, рентген зуба мудрости и др. Каждый
                    вид рентгеновского снимка имеет свои особенности и
                    применение, поэтому выбор зависит от конкретной ситуации и
                    требований врача.
                  </p>
                </section>
                <div className="divider"></div>
