...
`;
  ...
  return (
    <div className="div">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Компьютерная томография зубов и челюстей в Ивантеевке</title>
        <meta
          property="og:title"
          content="Компьютерная томография зубов и челюстей в Ивантеевке"
        ></meta>
        <meta
          property="og:description"
          content=" Профессиональная КТ диагностика зубов и челюстей в Ивантеевке. Высокоточные результаты и безопасность процедуры. Записывайтесь на КТ у нас!"
        ></meta>
        <meta
          name="description"
          content=" Профессиональная КТ диагностика зубов и челюстей в Ивантеевке. Высокоточные результаты и безопасность процедуры. Записывайтесь на КТ у нас!"
      ...
      {isLoading ? (
        ...
        <div className="screen">
          <Helmet>
            <meta charSet="utf-8" />
            <title>
              Лечение зубов под наркозом в Ивантеевке | Стоматологии Dental Home
            </title>
            <meta
              property="og:title"
              content="Лечение зубов под наркозом в Ивантеевке | Стоматологии Dental Home"
            ></meta>
            <meta
              property="og:description"
              content=" Профессиональная КТ диагностика зубов и челюстей в Ивантеевке. Высокоточные результаты и безопасность процедуры. Записывайтесь на КТ у нас!"
            ...
            <div className="content">
              ...
              <div className="heading-container">
                <div className="bread-dots">
                  ...
                  <div className="circle"></div>
                  <Link to="/services/teeth-ct" className="link active">
                    Компьютерная томография (КТ) зубов
                  </Link>
                </div>
                <h1 className="heading">
                  Компьютерная томография (КТ) зубов в Ивантеевке
                </h1>
              ...
              <div className="information-container">
                ...
                <section className="information">
                  <h3 className="information-heading">
                    Компьютерная томография зубов и челюсти в Ивантеевке:
                    точность и безопасность
                  </h3>
                  <p className="information-paragraph">
                    Если вы задаетесь вопросом, как получить максимально точное
                    представление о состоянии своих зубов и челюсти, то
                    компьютерная томография (КТ) - это то, что вам нужно. В
                    стоматологии Dental Home мы предлагаем 3D компьютерную
                    томографию зубов, которая позволяет получить высокоточный
                    снимок полости рта.
                    <br /> <br />
                    КТ зубов - это современный метод диагностики, который
                    позволяет получить более подробную информацию, чем рентген.
                    Благодаря КТ, стоматолог может увидеть не только зубы, но и
                    кости, мягкие ткани и нервы. Это помогает более точно
                    определить причину болезней зубов и челюсти и выбрать
                    наиболее эффективное лечение.
                    <br />
                    <br />
                    Сделать КТ зубов в Ивантеевке можно в стоматологии Dental
                    Home. Наши специалисты используют современное оборудование,
                    которое обеспечивает высокую точность и безопасность
                    процедуры.
                  </p>
                  <div className="divider"></div>
                  <h3 className="information-heading">
                    Как проходит КТ зубов?
                  </h3>
                  <p className="information-paragraph">
                    Компьютерная томография зубов - это безболезненная
                    процедура, которая занимает всего несколько минут. Во время
                    КТ пациенту необходимо находиться в специальном аппарате,
                    который делает серию рентгеновских снимков. После этого
                    компьютер обрабатывает полученные данные и создает 3D модель
                    полости рта.
                    <br /> <br />
                    КТ зубов - это современный метод диагностики, который
                    позволяет получить более подробную информацию, чем рентген.
                    ...
                    <br />
                    <br />
                    КТ зубов - это безопасная процедура, которая не требует
                    особых подготовительных мер. Однако, если вы беременны или
                    подозреваете, что можете быть беременны, обязательно
                    сообщите об этом своему врачу перед процедурой.
                  </p>
                  <div className="divider"></div>

                  <h3 className="information-heading">
                    Для чего нужна КТ зубов?
                  </h3>
                  <p className="information-paragraph">
                    Компьютерная томография зубов может использоваться для
                    диагностики различных заболеваний и состояний полости рта,
                    таких как:
                    <br />
                    <br />
                    - кариес;
                    ...
                    <br />
                    <br />
                    КТ зубов также может использоваться для планирования
                    имплантации зубов и других хирургических процедур.
                  </p>
                  <div className="divider"></div>

                  <h3 className="information-heading">
                    Записаться на КТ зубов в Ивантеевке
                  </h3>
                  <p className="information-paragraph">
                    Если вы хотите сделать КТ зубов в Ивантеевке, то записаться
                    на прием в стоматологию Dental Home можно по телефону или
                    через онлайн-форму на нашем сайте. Наши специалисты помогут
                    вам подготовиться к процедуре и ответят на все ваши вопросы.
                    <br /> <br />
                    Компьютерная томография зубов - это современный и безопасный
                    метод диагностики, который позволяет получить максимально
                    точное представление о состоянии зубов и челюсти. Сделать КТ
                    зубов в Ивантеевке можно в стоматологии Dental Home, где вы
                    получите высококачественное лечение и заботливое отношение.
                  </p>
                </section>
              </div>
              ...
              <div className="upper-content">
                <div className="heading-container">
                  <div className="bread-dots-container">
                    ...
                    <div className="circle"></div>
                    <Link to="/services/teeth-pc" className="link active">
                      Компьютерная томография (КТ) зубов
                    </Link>
                  </div>
              ...
              <div className="services-content">
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      Если вы задаетесь вопросом, как получить максимально
                      точное представление о состоянии своих зубов и челюсти, то
                      компьютерная томография (КТ) - это то, что вам нужно. В
                      стоматологии Dental Home мы предлагаем 3D компьютерную
                      томографию зубов, которая позволяет получить высокоточный
                      снимок полости рта.
                      <br /> <br />
                      КТ зубов - это современный метод диагностики, который
                      позволяет получить более подробную информацию, чем
                      рентген. Благодаря КТ, стоматолог может увидеть не только
                      зубы, но и кости, мягкие ткани и нервы. Это помогает более
                      точно определить причину болезней зубов и челюсти и
                      выбрать наиболее эффективное лечение.
                      <br />
                      <br />
                      Сделать КТ зубов в Ивантеевке можно в стоматологии Dental
                      Home. Наши специалисты используют современное
                      оборудование, которое обеспечивает высокую точность и
                      безопасность процедуры.
                    </p>
                  </div>
                  <div className="information-two mt-5">
                    <h3 className="heading-info">Как проходит КТ зубов?</h3>
                    <p className="p-info">
                      Компьютерная томография зубов - это безболезненная
                      процедура, которая занимает всего несколько минут. Во
                      время КТ пациенту необходимо находиться в специальном
                      аппарате, который делает серию рентгеновских снимков.
                      После этого компьютер обрабатывает полученные данные и
                      создает 3D модель полости рта.
                      <br /> <br />
                      КТ зубов - это современный метод диагностики, который
                      позволяет получить более подробную информацию, чем
                      рентген. Благодаря КТ, стоматолог может увидеть не только
                  ...
                  <div className="information-two mt-5">
                    <h3 className="heading-info">Для чего нужна КТ зубов?</h3>
                    <p className="p-info">
                      Компьютерная томография зубов может использоваться для
                      диагностики различных заболеваний и состояний полости рта,
                      таких как:
                  ...
                  <div className="information-two mt-5">
                    ...
                    <p className="p-info">
                      Если вы хотите сделать КТ зубов в Ивантеевке, то
                      записаться на прием в стоматологию Dental Home можно по
                      телефону или через онлайн-форму на нашем сайте. Наши
                      специалисты помогут вам подготовиться к процедуре и
                      ответят на все ваши вопросы.
                      <br /> <br />
                      Компьютерная томография зубов - это современный и
                      безопасный метод диагностики, который позволяет получить
                      максимально точное представление о состоянии зубов и
                      челюсти. Сделать КТ зубов в Ивантеевке можно в
                      стоматологии Dental Home, где вы получите
                      высококачественное лечение и заботливое отношение.
                    </p>
                  </div>
                </div>
              </div>
