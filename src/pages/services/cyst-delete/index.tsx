              ...
              <div className="information-container">
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    ...
                    удаление зуба вместе с кистой. После этого, он очищает лунку
                    удаления кисты зуба и закрывает ее швами или специальным
                    материалом.
                  </p>
                </section>
                <div className="divider"></div>
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-two">
                    ...
                    <p className="p-info two">
                      ...
                      Затем он делает небольшой разрез в десне и удаляет кисту.
                      Если киста находится на корне зуба, может потребоваться
                      удаление зуба вместе с кистой. После этого, он очищает
                      лунку удаления кисты зуба и закрывает ее швами или
