...
`;
  ...
  return (
    <div className="div">
      <Helmet>
        <meta charSet="utf-8" />
        <title> Анализы в Ивантеевке | KDL лаборатория</title>
        <meta
          property="og:title"
          content=" Анализы в Ивантеевке | KDL лаборатория"
        ></meta>
        <meta
          property="og:description"
          content="Все виды анализов в лаборатории KDL на Рощинской 9 в Ивантеевке. Быстрый результат и удобное расположение. Записывайтесь на анализы у нас!
"
        ></meta>
        <meta
          name="description"
            ...
            <div className="content">
              ...
              <div className="heading-container">
                <div className="bread-dots">
                  ...
                  <div className="circle"></div>
                  <Link to="/services/analysis" className="link active">
                    Анализы
                  </Link>
                </div>
                <h1 className="heading">Анализы (KDL) в Ивантеевке</h1>
              ...
              <div className="information-container">
                ...
                <section className="information">
                  <h3 className="information-heading">
                    Сдача анализов в Ивантеевке - безопасно и комфортно
                  </h3>
                  <p className="information-paragraph">
                    Важной частью процесса диагностики заболеваний является
                    сдача анализов. Ведь именно результаты анализов позволяют
                    врачам определить, какие меры нужно принять для лечения
                    пациента. Если вы ищете место, где можно сдать анализы в
                    Ивантеевке, то вы попали по адресу.
                    <br />
                    <br />В нашей клинике мы предлагаем услуги по сдаче
                    анализов, которые проводятся на высоком уровне
                    профессионализма. Мы используем современное оборудование и
                    следим за тем, чтобы все процедуры были безопасными и
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    В нашей клинике вы можете сдать различные анализы, которые
                    могут помочь в диагностике различных заболеваний. Например,
                    мы предлагаем услуги по сдаче крови на общий анализ,
                    биохимический анализ, анализ на гормоны, анализ на инфекции
                    и многое другое. Кроме того, мы предлагаем услуги по сдаче
                    мочи на общий анализ, анализ на бактерии, анализ на гормоны
                    и др.
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    Выбирая нашу клинику для сдачи анализов, вы можете быть
                    уверены в качестве предоставляемых услуг. Мы работаем только
                    с опытными специалистами, которые знают свое дело и готовы
                    помочь вам в любой ситуации. Кроме того, мы предлагаем
                    доступные цены и гарантируем конфиденциальность результатов
                    анализов.
                    <br />
                    <br />
                    Если вы хотите сдать анализы в Ивантеевке, то обращайтесь к
                    нам. Мы готовы предоставить вам профессиональную помощь и
                    быстро получить результаты анализов. Запишитесь на прием уже
                    сегодня и заботьтесь о своем здоровье вместе с нами.
                  </p>
                </section>
                <div className="divider"></div>
              </div>
              ...
              <div className="services-content">
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-two mt-5">
                    ...
                    <p className="p-info">
                      В нашей клинике вы можете сдать различные анализы, которые
                      могут помочь в диагностике различных заболеваний.
                      Например, мы предлагаем услуги по сдаче крови на общий
                      анализ, биохимический анализ, анализ на гормоны, анализ на
                      инфекции и многое другое. Кроме того, мы предлагаем услуги
                      по сдаче мочи на общий анализ, анализ на бактерии, анализ
                      на гормоны и др.
                    </p>
                  </div>
                  <div className="information-two mt-5">
                    ...
                    <p className="p-info">
                      Выбирая нашу клинику для сдачи анализов, вы можете быть
                      уверены в качестве предоставляемых услуг. Мы работаем
                      только с опытными специалистами, которые знают свое дело и
                      готовы помочь вам в любой ситуации. Кроме того, мы
                      предлагаем доступные цены и гарантируем конфиденциальность
                      результатов анализов.
                      <br />
                      <br />
                      Если вы хотите сдать анализы в Ивантеевке, то обращайтесь
                      к нам. Мы готовы предоставить вам профессиональную помощь
                      и быстро получить результаты анализов. Запишитесь на прием
                  ...
                  <div className="information-two mt-5">
                    ...
                    <p className="p-info">
                      <a href="https://dental-home.ru/services/optg">
                        Запишитесь на ОПТГ снимок
                      </a>{" "}
                      в Ивантеевке уже сегодня и получите качественную
                      диагностику для своего здоровья. Независимо от того, нужен
                      ли вам детский снимок оптг или зубной снимок оптг - мы
                      готовы помочь вам!
                    </p>
                  </div>
                </div>
