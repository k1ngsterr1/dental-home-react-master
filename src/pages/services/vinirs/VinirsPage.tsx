              ...
              <div className="information-container">
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    ...
                    <a href="https://dental-home.ru/services/teeth-crowns">
                      При установке коронок
                    </a>{" "}
                    зубы препарируются, чтобы создать место для будущей коронки.
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    После изготовления протез устанавливается на зуб с помощью
                    специального цемента или клея. Врач проверяет соответствие
                    протеза ожиданиям пациента и вносит необходимые
                    корректировки.
                  </p>
                </section>
                <div className="divider"></div>
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      ...
                      чтобы сохранить их структуру.
                      <a href="https://dental-home.ru/services/teeth-crowns">
                        При установке коронок
                      </a>{" "}
                      зубы препарируются, чтобы создать место для будущей
                      коронки.
                      <br />
                      <br />
                      <strong>3. Оттиск зуба</strong>
