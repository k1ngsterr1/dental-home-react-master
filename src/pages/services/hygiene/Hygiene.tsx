  ...
  return (
    <div className="div">
      <Helmet>
        <meta charSet="utf-8" />
        <title>
          Здоровье полости рта и предупреждение заболеваний зубов в Ивантеевке
        </title>
        <meta
          property="og:title"
          content="Здоровье полости рта и предупреждение заболеваний зубов в
              Ивантеевке"
        ></meta>
        <meta
          property="og:description"
          content="Профилактические мероприятия для поддержания здоровья полости рта. Предотвратим заболевания и обучим здоровым привычкам и правильной гигиене полости рта"
        ></meta>
        <meta
          name="description"
          content="Профилактические мероприятия для поддержания здоровья полости рта. Предотвратим заболевания и обучим здоровым привычкам и правильной гигиене полости рта"
              ...
              <div className="information-container">
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    ...
                    рекомендуется всем пациентам, особенно тем, у кого есть
                    глубокие подвесные карманы и воспалительные процессы в
                    полости рта. Эти проблемы требуют более тщательного и
                    глубокого очищения, которое может быть достигнуто только при
                    помощи профессиональной гигиены. Для пациентов без проблем с
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    ...
                    вашу улыбку здоровой и красивой. Обратившись в нашу клинику,
                    вы получите высококачественное обслуживание от опытных
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-two">
                    ...
                    <p className="p-info two">
                      ...
                      в клинике Dental Home в Ивантеевке поможет вам
                      поддерживать здоровье ваших зубов и десен. Индикация
                      зубного налета, удаление зубных отложений ультразвуком и
                      полировка поверхностей зубов - это эффективные методы,
                      которые помогут вам достичь оптимальной гигиены полости
                      рта. Регулярное проведение профессиональной гигиены
                      полости рта поможет предотвратить развитие заболеваний
