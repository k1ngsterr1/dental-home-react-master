  ...
  return (
    <div className="div">
      <Helmet>
        <meta charSet="utf-8" />
        <title>
          Профессиональная чистка зубов в Ивантеевке | Стоматологии Dental Home{" "}
        </title>
        <meta
          property="og:title"
          content="Профессиональная чистка зубов в Ивантеевке | Стоматологии Dental Home"
        ></meta>
        <meta
          property="og:description"
          content="Получите красивую улыбку и здоровые зубы с профессиональной чисткой зубов в Ивантеевке. Запишитесь на прием в нашу сеть стоматологий уже сегодня!
"
        ></meta>
        <meta
          name="description"
      ...
      {isLoading ? (
        ...
        <div className="screen">
          <Helmet>
            <meta charSet="utf-8" />
            <title>
              Профессиональная чистка зубов в Ивантеевке | Стоматологии Dental
              Home
            </title>
            <meta
              property="og:title"
              ...
              <div className="information-container">
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    Профессиональная чистка зубов - это не просто косметическая
                    процедура, а важная часть гигиены полости рта. Ведь здоровье
                    зубов и десен напрямую связано с общим состоянием организма.
                    И если вы ищете профессиональную гигиену полости рта в
                    Ивантеевке, то вы попали по адресу. <br /> <br /> В нашей
                    стоматологии мы предлагаем комплексную процедуру, включающую
                    удаление зубного налета, отбеливание Air Flow и безопасное
                    удаление зубного камня с помощью ультразвуковой аппаратуры.
                    Наш стоматолог-гигиенист проведет профессиональную чистку
                    зубов, используя только современное оборудование и
                    материалы. Удаление пигментированного зубного налета
                    системой Kavo Prophylaxe air flow, за счет чего достигается
                    отбеливание Зубов. <br /> <br /> Важно отметить, что
                    регулярная профессиональная чистка зубов является
                    необходимой профилактикой заболеваний полости рта. Она
                    помогает избавиться от камня и предотвратить развитие
                    кариеса, пародонтоза и других патологий. Причиной зубного
                    камня могут быть нарушения обмена веществ, неправильный уход
                    за полостью рта и отсутствие сырых овощей и фруктов в
                    рационе. Поэтому, чтобы сохранить здоровье зубов и десен,
                    необходимо регулярно посещать стоматолога и проводить
                    профессиональную гигиену полости рта. <br /> <br />{" "}
                    Стоимость гигиены полости рта в Ивантеевке доступна для всех
                    наших пациентов. Мы ценим каждого клиента и готовы
                    предложить индивидуальный подход к каждому случаю. Наша цель
                    - помочь вам сохранить здоровье зубов и десен, а также
                    красивую улыбку на долгие годы. Не откладывайте визит к
                    стоматологу на потом. Запишитесь на профессиональную чистку
                    зубов в Ивантеевке уже сегодня и получите эффективную
                    профилактику заболеваний полости рта по доступной цене. Наш
                    стоматолог-гигиенист сделает все возможное, чтобы ваша
                    улыбка всегда была здоровой и красивой.
                  </p>
                </section>
                <div className="divider"></div>
                <div className="plate">
              ...
              <div className="services-content">
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      Профессиональная чистка зубов - это не просто
                      косметическая процедура, а важная часть гигиены полости
                      рта. Ведь здоровье зубов и десен напрямую связано с общим
                      состоянием организма. И если вы ищете профессиональную
                      гигиену полости рта в Ивантеевке, то вы попали по адресу.{" "}
                      <br /> <br />В нашей стоматологии мы предлагаем
                      комплексную процедуру, включающую удаление зубного налета,
                      отбеливание Air Flow и безопасное удаление зубного камня с
                      помощью ультразвуковой аппаратуры. Наш
                      стоматолог-гигиенист проведет профессиональную чистку
                      зубов, используя только современное оборудование и
                      материалы. Удаление пигментированного зубного налета
                      системой Kavo Prophylaxe air flow, за счет чего
                      достигается отбеливание Зубов. <br /> <br /> Важно
                      отметить, что регулярная профессиональная чистка зубов
                      является необходимой профилактикой заболеваний полости
                      рта. Она помогает избавиться от камня и предотвратить
                      развитие кариеса, пародонтоза и других патологий. Причиной
                      зубного камня могут быть нарушения обмена веществ,
                      неправильный уход за полостью рта и отсутствие сырых
                      овощей и фруктов в рационе. Поэтому, чтобы сохранить
                      здоровье зубов и десен, необходимо регулярно посещать
                      стоматолога и проводить профессиональную гигиену полости
                      рта. <br /> <br />
                      Стоимость гигиены полости рта в Ивантеевке доступна для
                      всех наших пациентов. Мы ценим каждого клиента и готовы
                      предложить индивидуальный подход к каждому случаю. Наша
                      цель - помочь вам сохранить здоровье зубов и десен, а
                      также красивую улыбку на долгие годы. Не откладывайте
                      визит к стоматологу на потом. Запишитесь на
                      профессиональную чистку зубов в Ивантеевке уже сегодня и
                      получите эффективную профилактику заболеваний полости рта
                      по доступной цене. Наш стоматолог-гигиенист сделает все
                      возможное, чтобы ваша улыбка всегда была здоровой и
                      красивой.
                    </p>
                  </div>
                    ...
                    <div className="prices">
                      ...
                      <div className="price-row ">
                        <span className="text">
                          ...
                          подбор средств и предметов гигиены полости рта <br />{" "}
                          <br /> (А14.07.008)
                        </span>
                        <span className="price"> От 400 ₽</span>
                      </div>
