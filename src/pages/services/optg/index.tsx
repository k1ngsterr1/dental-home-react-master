...
`;
  ...
  return (
    <div className="div">
      <Helmet>
        <meta charSet="utf-8" />
        <title>ОПТГ в Ивантеевке | Dental Home</title>
        <meta
          property="og:title"
          content="ОПТГ в Ивантеевке | Dental Home "
        ></meta>
        <meta
          property="og:description"
          content="Безболезненная диагностика зубов и челюстей на аппарате ОПТГ в стоматологии Dental Home. Качественные результаты и профессиональное лечение. Записывайтесь на консультацию! 
Основная категория: Консультации
"
        ></meta>
        <meta
          name="description"
          ...
          <main className="services-screen-mobile">
            <div className="content">
              ...
              <div className="heading-container">
                ...
                <h1 className="heading">ОПТГ в Ивантеевке</h1>
              ...
              <div className="information-container">
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    Сделать снимок полости рта - это просто и безболезненно. Но
                    как получить максимально точную информацию о состоянии зубов
                    и десен? Ответ прост: выберите ОПТГ снимок в Ивантеевке.
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                  <h3 className="information-heading">
                    Что такое ОПТГ снимок?
                  </h3>
                  <p className="information-paragraph">
                    Это рентгеновский снимок, который позволяет получить полную
                    картину зубной системы, включая корни зубов и соседние
                    ткани. Благодаря этому, стоматолог может выявить проблемы,
                    которые не видны на обычном рентгене.
                    <br />
                    <br />
                    Если вы хотите сделать снимок оптг зубов или снимок оптг
                    ребенку, то ОПТГ снимок - это идеальный выбор. Он безопасен
                    для здоровья и не вызывает дискомфорта.
                    <br />
                    <br />
                    Кроме того, ОПТГ снимок в Ивантеевке - это быстрый и удобный
                    метод диагностики. Вы можете сделать снимок полости рта
                    панорамный или снимок челюсти оптг всего за несколько минут.
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    ...
                    Если вы ищете снимок полости рта панорамный цена - у нас вы
                    найдете оптимальное соотношение цены и качества.
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    ...
                    Независимо от того, нужен ли вам {""}
                    <a href="https://dental-home.ru/children-dental">
                      {""}
                      детский снимок {""}
                      {""}
                    </a>
                    оптг или зубной снимок оптг - мы готовы помочь вам!
                  </p>
                </section>
              </div>
