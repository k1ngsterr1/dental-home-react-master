...
"
      ...
      {isLoading ? (
        ...
        <div className="screen">
          <Helmet>
            <meta charSet="utf-8" />
            <title>Лечение пульпита зубов в Ивантеевке | Dental Home</title>
            <meta
              property="og:title"
              content="Лечение пульпита зубов в Ивантеевке | Dental Home"
            ></meta>
            <meta
              property="og:description"
              content="Наши стоматологи в Dental Home в Ивантеевке проведут эффективное лечение пульпита, вернув здоровье вашим зубам. Доверьтесь профессионалам"
            ></meta>
            <meta
              name="description"
              content="Наши стоматологи в Dental Home в Ивантеевке проведут эффективное лечение пульпита, вернув здоровье вашим зубам. Доверьтесь профессионалам"
            ...
            <div className="content">
              ...
              <div className="heading-container">
                <div className="bread-dots">
                  ...
                  <div className="circle"></div>
                  <Link to="/services/pulpitis-healing" className="link active">
                    Лечение пульпита
                  </Link>
                </div>
              ...
              <div className="information-container">
                ...
                <section className="information">
                  <h3 className="information-heading">
                    Лечение пульпита зубов в Ивантеевке: эффективное решение
                    проблемы с зубной болью
                  </h3>
                  <p className="information-paragraph">
                    Пульпит – это воспалительное заболевание зубной пульпы,
                    которое может привести к неприятным ощущениям и даже
                    серьезным осложнениям, если не обратиться к специалисту
                    своевременно. В нашей стоматологической клинике в Ивантеевке
                    мы предлагаем профессиональное лечение пульпита, которое
                    поможет избавиться от боли и сохранить ваш зуб.
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                  <h3 className="information-heading">
                    Процесс лечения пульпита в нашей клинике
                  </h3>
                  <p className="information-paragraph">
                    Наши опытные стоматологи проведут тщательное обследование
                    зуба, чтобы определить степень поражения пульпы и
                    разработать индивидуальный план лечения. Мы используем
                    современное оборудование и высококачественные материалы для
                    проведения процедур лечения пульпита. Благодаря нашему опыту
                    и профессионализму, мы гарантируем эффективный результат и
                    минимальные риски для вашего здоровья.
                  </p>
                </section>
                <section className="information">
                  <h3 className="information-heading">
                    Почему стоит выбрать нашу клинику для лечения пульпита?
                  </h3>
                  <p className="information-paragraph">
                    Мы ценим каждого пациента и стремимся обеспечить комфортное
                    и безопасное лечение. В нашей клинике в Ивантеевке вы
                    найдете дружелюбный коллектив специалистов, готовых помочь
                    вам решить проблему с пульпитом. Мы работаем на результат и
                    делаем все возможное, чтобы каждый пациент остался доволен
                    качеством наших услуг. <br /> <br /> Не откладывайте визит к
                    стоматологу, если у вас возникла боль или дискомфорт в зубе.
                    Обратитесь к нам в клинику, и мы поможем вам избавиться от
                    пульпита без лишних проблем. Доверьтесь профессионалам и
                    верните своей улыбке здоровье!
                  </p>
                </section>
                <div className="divider"></div>
                <div className="plate">
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      ...
                      которое может привести к неприятным ощущениям и даже
                      серьезным осложнениям, если не обратиться к специалисту
                      своевременно. В нашей стоматологической клинике в
                      Ивантеевке мы предлагаем профессиональное лечение
                      пульпита, которое поможет избавиться от боли и сохранить
                      ваш зуб.
                    </p>
                  </div>
                  <div className="information-two">
                    ...
                    <p className="p-info two">
                      ...
                      для проведения процедур лечения пульпита. Благодаря нашему
                      опыту и профессионализму, мы гарантируем эффективный
                      результат и минимальные риски для вашего здоровья.
                    </p>
                  </div>
                  <div className="information-two">
                    <h3 className="heading-info two">
                    ...
                    <p className="p-info two">
                      Мы ценим каждого пациента и стремимся обеспечить
                      комфортное и безопасное лечение. В нашей клинике в
                      Ивантеевке вы найдете дружелюбный коллектив специалистов,
                      готовых помочь вам решить проблему с пульпитом. Мы
                      работаем на результат и делаем все возможное, чтобы каждый
                      пациент остался доволен качеством наших услуг. <br />{" "}
                      <br /> Не откладывайте визит к стоматологу, если у вас
                      возникла боль или дискомфорт в зубе. Обратитесь к нам в
                      клинику, и мы поможем вам избавиться от пульпита без
                      лишних проблем. Доверьтесь профессионалам и верните своей
                      улыбке здоровье!
                    </p>
                  </div>
                  <div className="divider"></div>
