            ...
            <div className="content">
              ...
              <div className="heading-container">
                <div className="bread-dots">
                  ...
                  <div className="circle"></div>
                  <Link to="/services/caries-heal" className="link active">
                    Лечение кариеса
                  </Link>
                </div>
              ...
              <div className="information-container">
                ...
                <section className="information">
                  <h3 className="information-heading">
                    Лечение кариеса зубов в Ивантеевке: забота о вашей улыбке
                  </h3>
                  <p className="information-paragraph">
                    Важно помнить, что здоровье зубов – залог красивой улыбки и
                    общего благополучия. В нашей стоматологической клинике в
                    Ивантеевке мы предлагаем профессиональное лечение кариеса с
                    использованием передовых методик и материалов.
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                  <h3 className="information-heading">
                    Преимущества лечения кариеса у наc
                  </h3>
                  <p className="information-paragraph">
                    Наши опытные специалисты обладают высоким уровнем
                    профессионализма и готовы помочь вам избавиться от кариеса
                    эффективно и безболезненно. Мы используем инновационное
                    оборудование и материалы высокого качества, чтобы обеспечить
                    долговременные результаты.
                  </p>
                </section>
                <section className="information">
                  <h3 className="information-heading">
                    Забота о вашем комфорте и здоровье
                  </h3>
                  <p className="information-paragraph">
                    Мы понимаем, что поход к стоматологу может вызывать
                    беспокойство, поэтому создаем атмосферу доверия и уюта. Наша
                    команда стремится сделать процедуру лечения кариеса
                    максимально комфортной для каждого пациента, учитывая
                    индивидуальные особенности и потребности. Приходите в нашу
                    клинику в Ивантеевке, и мы поможем вам вернуть здоровье
                    вашим зубам и улыбке. Доверьтесь профессионалам и
              ...
              <div className="services-content">
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      Важно помнить, что здоровье зубов – залог красивой улыбки
                      и общего благополучия. В нашей стоматологической клинике в
                      Ивантеевке мы предлагаем профессиональное лечение кариеса
                      с использованием передовых методик и материалов.
                    </p>
                  </div>
                  <div className="information-two">
                    <h3 className="heading-info two">
                      Преимущества лечения кариеса у нас
                    </h3>
                    <p className="p-info two">
                      Наши опытные специалисты обладают высоким уровнем
                      профессионализма и готовы помочь вам избавиться от кариеса
                      эффективно и безболезненно. Мы используем инновационное
                      оборудование и материалы высокого качества, чтобы
                      обеспечить долговременные результаты.
                    </p>
                  </div>
                  <div className="information-two">
                    <h3 className="heading-info two">
                    ...
                    <p className="p-info two">
                      Мы понимаем, что поход к стоматологу может вызывать
                      беспокойство, поэтому создаем атмосферу доверия и уюта.
                      Наша команда стремится сделать процедуру лечения кариеса
                      максимально комфортной для каждого пациента, учитывая
                      индивидуальные особенности и потребности. Приходите в нашу
                      клинику в Ивантеевке, и мы поможем вам вернуть здоровье
                      вашим зубам и улыбке. Доверьтесь профессионалам и
