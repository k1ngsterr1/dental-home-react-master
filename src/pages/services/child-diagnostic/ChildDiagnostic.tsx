  ...
  return (
    <div className="div">
      <Helmet>
        ...
        <meta name="Обеспечьте своему ребенку точное определение проблем с полостью рта с помощью современных методов диагностики в клинике Dental Home в Ивантеевке"></meta>
      </Helmet>
