    ...
    <div className="div">
      {isLoading ? (
        ...
        <div className="screen">
          <Helmet>
            <meta charSet="utf-8" />
            <title>Имплантация All-on-4 в Ивантеевке | Dental Home</title>
            <meta
              property="og:title"
              content="Имплантация All-on-4 в Ивантеевке | Dental Home"
            ></meta>
            <meta
              property="og:description"
              content="Dental Home в Ивантеевке предлагает услугу имплантации All-on-4 для полной реставрации зубов. Опытные специалисты помогут восстановить вашу уверенную улыбку"
            ></meta>
            <meta
              name="description"
              content="Dental Home в Ивантеевке предлагает услугу имплантации All-on-4 для полной реставрации зубов. Опытные специалисты помогут восстановить вашу уверенную улыбку"
            ...
            <div className="content">
              ...
              <div className="heading-container">
                <div className="bread-dots">
                  ...
                  <div className="circle"></div>
                  <Link to="/services/allon4" className="link active">
                    Имплантация All-on-4
                  </Link>
                </div>
                <h1 className="heading">
                  Имплантация зубов All-on-4 в Ивантеевке
                </h1>
              ...
              <div className="information-container">
                ...
                <section className="information">
                  ...
                  <p className="information-paragraph">
                    Имплантация All-on-4 - современный метод восстановления
                    зубов, который предлагает Dental Home в Ивантеевке. Эта
                    процедура позволяет восстановить полностью или частично
                    отсутствующие зубы с использованием всего четырех
                    имплантатов. Это надежное и эффективное решение для тех, кто
                    хочет вернуть себе красивую улыбку и функциональность рта.
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                  <h3 className="information-heading">
                    Преимущества имплантации All-on-4 в Dental Home
                  </h3>
                  <p className="information-paragraph">
                    В Dental Home мы предлагаем высококачественную имплантацию
                    All-on-4 под контролем опытных специалистов. Наша команда
                    обеспечит вам индивидуальный подход, комфорт во время
                    процедуры и качественное послеоперационное обслуживание. С
                    помощью имплантации All-on-4 вы сможете наслаждаться
                    прочными и красивыми зубами, восстановленной жевательной
                    функцией и уверенной улыбкой.
                  </p>
                </section>
                <div className="divider"></div>
                <section className="information">
                  <h3 className="information-heading">
                    Почему выбирают Dental Home для имплантации All-on-4?
                  </h3>
                  <p className="information-paragraph">
                    Dental Home - это место, где забота о вашем здоровье и
                    комфорте стоит на первом месте. Наши специалисты имеют
                    обширный опыт в проведении имплантации All-on-4 и
                    гарантируют безопасность и эффективность процедуры. Мы
                    используем только современное оборудование и материалы,
                    чтобы обеспечить нашим пациентам лучшие результаты. Доверьте
                    свою улыбку профессионалам Dental Home и наслаждайтесь
                    результатом!
                  </p>
                </section>
                <div className="divider"></div>
                ...
                <div className="services-information" id="information">
                  ...
                  <div className="information-one">
                    ...
                    <p className="p-info">
                      ...
                      процедура позволяет восстановить полностью или частично
                      отсутствующие зубы с использованием всего четырех
                      имплантатов. Это надежное и эффективное решение для тех,
                      кто хочет вернуть себе красивую улыбку и функциональность
                      рта.
                    </p>
                  </div>
                  ...
                  <div className="information-two">
                    ...
                    <p className="p-info two">
                      ...
                      гарантируют безопасность и эффективность процедуры. Мы
                      используем только современное оборудование и материалы,
                      чтобы обеспечить нашим пациентам лучшие результаты.
                      Доверьте свою улыбку профессионалам Dental Home и
